...
/**
 * Plugin's Base Class where store plugin's
 * dev_version, base_url, base_dir, assets_url etc
 * 
 * -------------------------
 * IMPORTANT
 * -------------------------
 * Obviously we have to call this base class everywhere.
 * we always extends this class
 * 
 * and this is actually an Abstract class
 * 
 * @since 1.0.0.0 starting from begining of Saiful B a s e  p l u g i n
 * 
...
abstract class Base{
    ...
    public $plugin_prefix = PSSG_PREFIX;
    public $dev_version = PSSG_DEV_VERSION;
    public $plugin_name = PSSG_PLUGIN_NAME;
    public $base_url = PSSG_BASE_URL;
    public $base_dir = PSSG_BASE_DIR;
    public $assets_url = PSSG_ASSETS_URL;
